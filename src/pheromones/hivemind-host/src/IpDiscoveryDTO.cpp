...
IPDiscoveryDTO::IPDiscoveryDTO() { m_ip = std::monostate(); }

const std::variant<std::monostate, uint32_t>& IPDiscoveryDTO::getIP() const { return m_ip; }

void IPDiscoveryDTO::setIP(const std::variant<std::monostate, uint32_t>& ip) { m_ip = ip; }
