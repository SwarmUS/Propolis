...
class RequestDTO {
  ...
  public:
    ...
    RequestDTO(uint32_t id, const HiveMindHostApiRequestDTO& request);
     ...
     */
    const std::variant<std::monostate, UserCallRequestDTO, HiveMindHostApiRequestDTO>& getRequest()
        const;
  ...
  private:
    ...
    std::variant<std::monostate, UserCallRequestDTO, HiveMindHostApiRequestDTO> m_request;
};
