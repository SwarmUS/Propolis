...
HiveConnectNetworkConfigGetResponseDTO::HiveConnectNetworkConfigGetResponseDTO(HiveConnectNetworkAccessDTO networkAccess,
...
HiveConnectNetworkConfigGetResponseDTO::HiveConnectNetworkConfigGetResponseDTO(const HiveConnectNetworkConfigGetResponse& getResponse) :
    m_networkAccess(getResponse.network_access),
    m_rootNode(getResponse.root_node),
    m_meshEnable(getResponse.mesh_enable) {}

void HiveConnectNetworkConfigGetResponseDTO::setSSIDAndPassword(const char* ssid, const char* password) {
...
bool HiveConnectNetworkConfigGetResponseDTO::isRootNode() const {
    return m_rootNode.isRootNode();
}
...
bool HiveConnectNetworkConfigGetResponseDTO::serialize(HiveConnectNetworkConfigGetResponse& getResponse) {
